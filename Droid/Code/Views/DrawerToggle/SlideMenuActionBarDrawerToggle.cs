...
namespace actchargers.Droid.DrawerToggle
{
    ...
    public class SlideMenuActionBarDrawerToggle : ActionBarDrawerToggle
    {
        public SlideMenuActionBarDrawerToggle (Activity activity, DrawerLayout drawerLayout, int openDrawerContentDescRes, int closeDrawerContentDescRes)
