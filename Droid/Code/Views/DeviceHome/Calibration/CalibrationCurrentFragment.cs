...
{
    public class CalibrationCurrentFragment : MvxFragment
    {
       ...
       private CustomSectionEditAdapter adapter;
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            adapter = new CustomSectionEditAdapter(view.Context, (IMvxAndroidBindingContext)BindingContext, _mCalibrationViewModel.CalibrationCurrentItemSource, _mCalibrationViewModel);
        ...
        {
            if (e.PropertyName.Equals("CalibrationCurrentItemSource"))
            {
                _mListView.ExpandAllGroups();
                adapter.ItemsSource = _mCalibrationViewModel.CalibrationCurrentItemSource;
