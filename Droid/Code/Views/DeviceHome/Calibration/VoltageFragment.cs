...
{
    public class VoltageFragment : MvxFragment
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
           ...
           _mListView = view.FindViewById<CiExpandableListView>(Resource.Id.section_list);
            adapter = new CustomSectionEditAdapter(view.Context, (IMvxAndroidBindingContext)BindingContext, _mCalibrationViewModel.CalibrationVoltageItemSource, _mCalibrationViewModel);
        ...
        {
            if (e.PropertyName.Equals("CalibrationVoltageItemSource"))
            {
			   _mListView.ExpandAllGroups();
                adapter.ItemsSource = _mCalibrationViewModel.CalibrationVoltageItemSource;
