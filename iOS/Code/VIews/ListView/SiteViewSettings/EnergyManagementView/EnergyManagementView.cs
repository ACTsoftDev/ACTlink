...
{
    public partial class EnergyManagementView : ListViewBaseView
    {
        public EnergyManagementView() : base("EnergyManagementView", null)
        {
        }
        ...
        internal override void InitData()
        {
            ...
            this.CreateBinding(source).For(s => s.ListItemsSource).To((EnergyManagementViewModel vm) => vm.ItemSource).Apply();
