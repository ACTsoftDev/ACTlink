...
{
    public partial class ThreeLabelTableViewCell : MvxTableViewCell
    {
        public static readonly NSString Key = new NSString("ThreeLabelTableViewCell");
        public static readonly UINib Nib;

        /// <summary>
        /// Initializes the <see cref="T:actchargers.iOS.ThreeLabelTableViewCell"/> class.
        /// </summary>
        static ThreeLabelTableViewCell()
        {
            Nib = UINib.FromName("ThreeLabelTableViewCell", NSBundle.MainBundle);
        }
        ...
        protected ThreeLabelTableViewCell(IntPtr handle) : base(handle)
        {
            ...
            this.DelayBind(() =>
            {
                ...
                var set = this.CreateBindingSet<ThreeLabelTableViewCell, ListViewItem>();
